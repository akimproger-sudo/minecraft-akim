...
text
      ...
      Нижний круг (y=82, радиус 3)
           ↓
         ЦЕЛЬ (187 80 6) 💥
Альтернативный вариант (если хочешь, чтобы динамит реально описывал дугу вокруг цели):
Могу сделать вариант с area_effect_cloud и телепортацией TNT каждые 2 тика для идеального круга. Напиши, если нужен такой вариант!
